        ...
        <>
            ...
            <div className='flex justify-start gap-16 items-center my-12'>
                <Avatar className='w-28 h-28 bg-purple-50 border-purple-900 border'>
                    <AvatarFallback className='text-5xl text-purple-900'>KD</AvatarFallback>
                </Avatar>
                <div className='flex-col'>
                    <div className='text-lg text-gray-900 mb-4'> Karthigesu Dilani</div>
                    <div className='text-md text-gray-900'> dilani@gmail.com</div>
                </div>
            </div>
