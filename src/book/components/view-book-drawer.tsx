            ...
            <div className='ms-16'>
                <table>
                    ...
                    <tr>
                        ...
                        <td className='text-sm text-gray-900 ps-16'>{book['description']}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className='text-sm text-gray-900 ps-16'>{book['publish_date']}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className='text-sm text-gray-900 ps-16'>
                            <div
                                key={`status2`}
                                className={`w-28 text-center rounded-full p-2 ${book.status == 'In Stock' ? 'bg-purple-100 text-purple-900' : 'bg-red-100 text-red-900'}`}
                            >
                                {book['status']}
                            </div>
                        </td>
