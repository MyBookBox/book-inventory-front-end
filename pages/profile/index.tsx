...
const Profile = () => {
  ...
  const onSubmit = async (data: ResetPasswordForm) => {
    if (data.confirmPassword != data.newPassword) {
      toast.error(
        "The new password and confirm password do not match. Please ensure both fields contain the same password"
      );
  ...
  return (
    <>
      ...
      {/* Profile Section */}
      <div className="flex flex-col lg:flex-row justify-start gap-8 lg:gap-16 items-center my-12">
      ...
      <div className="shadow-md p-8 w-full lg:w-1/2">
        <div className="text-2xl text-purple-900 mb-6">Change Password</div>
